  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute top-1/2 -translate-y-2/3 left-4 md:left-7 right-4 font-heading font-bold text-[#FFF] flex flex-col md:flex-row items-start gap-3 md:gap-4 uppercase">
          <p className="text-[28px] md:text-[48px] pt-0 md:pt-[12px]">Tired of the</p>
          <div className="text-[40px] md:text-[70px]">
            ...
            <p className="font-sans text-[16px] md:text-[30px] mt-4 md:mt-8 mb-2">This is where your Experience begins</p>

            <button className="bg-[#FFD425] hover:bg-[#FFF2BF] transition duration-200 ease-in-out font-medium rounded-[4px] font-sans text-[#333333] text-[16px] md:text-[24px] px-4 py-2">Know More</button>
          </div>
        </div>

        <Image src="quote.svg" className="left-1/2 -translate-x-1/2 absolute bottom-10 md:bottom-24 w-[220px] md:w-[400px]" width={400} height={200} alt="For Travellers By Travllers" />


      </section>
      <section className="px-6 md:px-20 py-10 md:py-18">
        <h1 className="text-[#493628] font-bold font-heading text-[44px] md:text-[108px]">INTERNATIONAL TRIPS</h1>
      ...
      <section className="px-6 md:px-20 py-10 md:py-18">
        <h1 className="text-[#493628] font-bold font-heading text-[44px] md:text-[108px]">INDIA TRIPS</h1>
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {
      ...
      <section className="relative h-[220px] md:h-[300px] mx-6 md:mx-28 my-10 md:my-18 rounded-[33px] overflow-hidden">
        <Image
        ...
        <div className="relative px-6 md:px-12 py-6 md:py-8">
          ...
          <h4 className="text-[#FFF] font-medium font-sans text-[16px] md:text-[32px]">Good. That&apos;s where limitless journeys begin</h4>
          <button className="mt-4 md:mt-8 bg-[#FFD425] hover:bg-[#FFF2BF] transition duration-200 ease-in-out font-medium rounded-[4px] font-sans text-[#333333] text-[16px] md:text-[24px] px-4 py-2">Know More</button>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-10 md:py-18">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="w-full md:w-1/2">
            <h1 className="text-[#493628] font-bold font-heading text-[44px] md:text-[100px]">WHY KARVAANN?</h1>
        ...
        <div className="grid mt-10 md:mt-18 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 md:gap-12">
