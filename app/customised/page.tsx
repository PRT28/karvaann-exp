  ...
  return (
    <main className="font-sans text-[#4b3b2b]">
      ...
      <section className="px-6 md:px-20 py-16">
        <div className="max-w-5xl mx-auto bg-[#fff7df] rounded-[12px] shadow-[0_10px_30px_rgba(0,0,0,0.08)] p-8 md:p-12">
      ...
      <section className="px-6 md:px-20 pb-24">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-[22px] md:text-[28px] font-semibold text-[#6a594d]">
