  ...
  return (
    <main className="font-sans text-[#4b3b2b]">
      <section className="relative min-h-[260px] md:min-h-[360px] overflow-hidden">
        ...
        <div className="relative z-10 px-6 md:px-20 py-14 md:py-24">
      ...
      <section className="px-6 md:px-20 py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <p className="font-sans text-[16px] md:text-[18px] w-full md:w-1/2">
      ...
      <section className="px-6 md:px-20 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between gap-10">
      ...
      <section className="px-6 md:px-20 py-12 md:py-16">
        <h1 className="text-[#493628] font-bold font-heading text-[40px] md:text-[100px]">Meet the minds behind the experiences</h1>
        <div className="flex flex-col md:flex-row mt-16 md:mt-48 items-center gap-8">
            <Image
            ...
            />
            <div className="">
                <h1 className="font-heading text-[#493628] font-bold text-[36px] md:text-[60px]">Vishwanath Manocha</h1>
                <div className="inline-flex mt-6 md:mt-8 mb-8 md:mb-12 font-bold items-center gap-3 bg-[#FFC709] text-[#3b2a1f] font-sans uppercase px-4 py-2 rounded-sm text-[18px] md:text-[20px]">
                    Founder
                </div>
        ...
        <div className="flex flex-col md:flex-row mt-16 md:mt-48 items-center gap-8">
            ...
            />
            <div className="">
                <h1 className="font-heading text-[#493628] font-bold text-[36px] md:text-[60px]">Yash Manocha</h1>
                <div className="inline-flex mt-6 md:mt-8 mb-8 md:mb-12 font-bold items-center gap-3 bg-[#FFC709] text-[#3b2a1f] font-sans uppercase px-4 py-2 rounded-sm text-[18px] md:text-[20px]">
                    Co-Founder
                </div>
        ...
        <div className="flex flex-col md:flex-row mt-16 md:mt-48 items-center gap-8">
            ...
            />
            <div className="">
                <h1 className="font-heading text-[#493628] font-bold text-[36px] md:text-[60px]">Shivam Manocha</h1>
                <div className="inline-flex mt-6 md:mt-8 mb-8 md:mb-12 font-bold items-center gap-3 bg-[#FFC709] text-[#3b2a1f] font-sans uppercase px-4 py-2 rounded-sm text-[18px] md:text-[20px]">
                    Co-Founder
                </div>
                <p>Yash, our adventure-loving co-founder, has a mountaineering certification and an insatiable passion for travel. A social butterfly with a sharp eye for detail, he balances fun and work effortlessly. His boundless energy ensures every Karvaann trip is as thrilling as it is unforgettable.</p>
