  ...
  return (
    <main className="font-sans text-[#4b3b2b]">
      <section className="relative min-h-[280px] md:min-h-[360px] overflow-hidden">
        ...
        <div className="relative z-10 px-8 md:px-20 py-20 md:py-24">
          <div className="font-heading uppercase text-[#FFC709] text-[64px] md:text-[96px] leading-tight tracking-wide">
            Contact Us
          </div>
          <div className="w-[380px] md:w-[520px] mt-4 bg-[#FFC709] h-[2px]" />
        </div>
      </section>

      <section className="px-6 md:px-20 py-16 text-center">
        <div className="inline-flex font-bold items-center gap-3 bg-[#FFE9A6] text-[#3b2a1f] font-sans px-6 py-2 rounded-md text-[16px] shadow-sm">
          Let’s start a conversation
        </div>
        <p className="mt-8 text-[16px] md:text-[18px] text-[#7a6a5d] max-w-3xl mx-auto leading-7">
      ...
      <section className="px-6 md:px-20 py-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-[26px] md:text-[32px] font-semibold text-[#6a594d]">Get in Touch</h2>
      ...
      <section className="px-6 md:px-20 py-16">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-[26px] md:text-[32px] font-semibold text-[#6a594d]">Business Hours</h2>
