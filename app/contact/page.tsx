...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Karvaann Experiences for leisure and corporate travel planning, support, and booking assistance.",
  keywords: [
    "contact Karvaann",
    "travel support",
    "travel booking contact",
    "corporate travel inquiry",
    "leisure travel inquiry",
  ],
  openGraph: {
    title: "Contact Us | Karvaann Experiences",
    description: "Get in touch with Karvaann Experiences for leisure and corporate travel planning, support, and booking assistance.",
  ...
  return (
    <main className="font-sans text-[#4b3b2b]">
      <section className="relative min-h-[260px] md:min-h-[360px] overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1541410965313-d53b3c16ef17?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center" />
      ...
      <section className="px-6 md:px-28 py-6 md:py-8">
